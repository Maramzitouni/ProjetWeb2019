                    ...
                    <div class="dropdown">
                        <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                          ...
                          <div class="dropdown-menu" aria-labelledby="#dropdownMenuButton">
                            <a class="dropdown-item" href="admin/toutEvents.php">Liste d'Events</a>
                            <a class="dropdown-item" href="admin/listusers.php">Gérer les users</a>
                            <a class="dropdown-item" href="admin/creer_event.php">Créer un event</a>
                          </div> 
                    </div>
